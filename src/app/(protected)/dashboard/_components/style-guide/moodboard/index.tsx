...
import { MoodBoardImage, useStyleGuideMoodBoard } from "@/hooks/use-styles";
...
const StyleGuideMoodBoard = ({ guideImages }: StyleGuideMoodBoardProps) => {
  const {
    images,
    dragActive,
    removeImage,
    ...
    handleFileInput,
    canAddMore,
  } = useStyleGuideMoodBoard(guideImages);
    ...
    <div className="flex flex-col gap-10">
      ...
      >
        <div className="absolute inset-0 opacity-5">
          <div className="size-full bg-linear-to-br from-primary/20 to-transparent rounded-3xl" />
        </div>
            ...
            <div className="lg:hidden absolute inset-0 flex items-center justify-center">
              <div className="relative">
                {images.map((image, index) => {
                  ...
                  const rotation = (random1 - 0.5) * 20; // -10 to +10 degress for subtle tilt
                  const xOffset = (random2 - 0.5) * 40; // -20 to +20 pixels for horizontal offset
                  const yOffset = (random3 - 0.5) * 30; // -15 to +15 pixels for vertical offset
            ...
            <div className="hidden lg:flex absolute inset-0 items-center justify-center">
              <div className="relative w-full max-w-[700px] h-[300px] mx-auto">
                {images.map((image, index) => {
                  ...
                  const rotation = (random1 - 0.5) * 50; // -25 to +25 degress for subtle tilt
                  const xOffset =
